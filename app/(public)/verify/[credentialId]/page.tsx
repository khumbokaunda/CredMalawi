...
import { useCredential } from "@/lib/store";
...
export default function VerifyPage({
  ...
  const credential = useCredential(params.credentialId);
    ...
    <div>
      <div className="border-b border-slate-200 bg-white">
        <div className="container-page flex items-center gap-2 py-4 text-sm text-slate-500">
          <ShieldCheck className="h-4 w-4 text-ictam" />
      ...
      <div className="container-page grid gap-8 py-10 lg:grid-cols-3">
        ...
        <div className="space-y-6">
            ...
            <Reveal delay={valid ? 1.3 : 0.3}>
              <div className="card p-6">
                ...
                <Link
                  ...
                  className="mt-4 inline-block text-sm font-semibold text-brandblue hover:underline"
                >
          ...
          <Reveal delay={valid ? 1.4 : 0.4}>
            <div className="panel p-6 text-xs leading-relaxed text-slate-500">
              <p className="font-semibold text-slate-700">About this check</p>
              <p className="mt-2">
